...
params ["_pod", "_assignedUnitGroup", "_launchVehicle"];//Issues without quotes around the variables 
...
//
["PodManualDetection - Calling landing sequence"] execVM PT_DEBUG_SQF;
...
// playSound3D [PT_POD_DECEL_NOISE, _pod, false, getPosATL _pod, PT_POD_DECEL_NOISE_VOL, 1];//Sound previously played after setting the decell velocity
...
// [_pod, _assignedUnitGroup, _launchVehicle] execVM "pooperTroopers\scripts\poopTroopSpawn.sqf";