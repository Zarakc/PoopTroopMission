//Pod Scripts
#define ME_POD_REINFORCEMENTS_ACE_EVENT "messyEvac\scripts\pod\reinforcementVehiclesAceEvent.sqf"
#define ME_POD_SEQUENCE_START "messyEvac\scripts\pod\podEnrouteSequence.sqf"
#define ME_POD_LANDING_SEQUENCE "messyEvac\scripts\pod\preparePodLandingSequence.sqf"
#define ME_POD_IMPACT_HANDLER "messyEvac\scripts\pod\podImpactEventHandler.sqf"
#define ME_POD_IMPACT_FOLLOWUP "messyEvac\scripts\pod\postImpactTrigger.sqf"
#define ME_POD_TROOPER_SPAWN "messyEvac\scripts\pod\podTrooperSpawn.sqf"

#define ME_POD_TYPE "Land_ToiletBox_F"

//Pod launching constants
#define ME_COORDINATE_VARIANCE 20

//Pod spawning constants
#define ME_INITIAL_SLEEP_ON_LAUNCH 28

#define ME_MANUAL_CHECK_DEBUG_HEIGHT 20
#define ME_MANUAL_CHECK_DECEL_HEIGHT 10
#define ME_MANUAL_CHECK_STOP_HEIGHT 0.2//Was 1.5


#define ME_POD_DECEL_VELOCITY [0, 0, -0.05]
#define ME_POD_OPEN_SPEED 2
#define ME_POD_PERSIST_DURATION 2
...
#define ME_UNIT_TYPE "UK3CB_CW_SOV_O_EARLY_RIF_2"

//"rhsusf\addons\rhsusf_a2port_air\data\sounds\ejection_sound.wss"
#define ME_POD_DECEL_NOISE "rhsusf\addons\rhsusf_a2port_air\data\sounds\ejection_sound.wss"
#define ME_POD_DECEL_VOL 2
#define ME_POD_IMPACT_NOISE "a3\sounds_f\vehicles2\armor\shared\collisions\vehicle_armor_collision_building_01.wss"
#define ME_POD_IMPACT_VOL 3
