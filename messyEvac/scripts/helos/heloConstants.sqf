...
#define ME_HELO_DISABLED_SCENARIOS [NO_FUEL_TANK, DMG_ENGINES, DMG_ENGINES, NO_ENGINES, NO_ENGINES, NO_FUEL_MROTOR_DMG_FUEL, NO_FUEL_MROTOR_DMG_FUEL, NO_ROTORS_DMG_ENG, FUCKED_UP, ALL_FUCKED_UP]
