...
[format["Helo %1 - Damage Init", _helo]] execVM ME_DEBUG_SQF;
...
[format["Helo %1 - Damage Scenario: %2", _helo, _dmgScenario]] execVM ME_DEBUG_SQF;
...
//Damage each of the specified helo parts
{
	...
	[format["Helo %1 - Damaging %2 to %3", _helo, _part, _dmgAmount]] execVM ME_DEBUG_SQF;
