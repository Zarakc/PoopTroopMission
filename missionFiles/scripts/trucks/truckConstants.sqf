...
#define PT_TRUCK_LOCATIONS [PT_TRUCK_FUEL_TANKS_SPAWN, PT_TRUCK_MAIN_WAREHOUSE_SPAWN, PT_TRUCK_E_GARAGE_1ST_SPAWN, PT_TRUCK_E_GARAGE_2ND_SPAWN]
...
#define PT_TRUCK_E_GARAGE_1ST_SPAWN [PT_TRUCK_E_GARAGE_1ST_POS, PT_TRUCK_E_GARAGE_1ST_ROT]
#define PT_TRUCK_E_GARAGE_1ST_POS [12456.072, 12546.477, 0.452]
#define PT_TRUCK_E_GARAGE_1ST_ROT 188

//Eastern Garage Slot #3
#define PT_TRUCK_E_GARAGE_2ND_SPAWN [PT_TRUCK_E_GARAGE_2ND_POS, PT_TRUCK_E_GARAGE_2ND_ROT]
#define PT_TRUCK_E_GARAGE_2ND_POS [12461.923, 12545.33, 0.373]
#define PT_TRUCK_E_GARAGE_2ND_ROT 188
