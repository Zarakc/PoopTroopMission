...
#define PT_TRUCK_LOCATIONS [PT_TRUCK_FUEL_TANKS_SPAWN, PT_TRUCK_MAIN_WAREHOUSE_SPAWN, PT_TRUCK_E_GARAGE_2_SPAWN, PT_TRUCK_E_GARAGE_3_SPAWN]
...
#define PT_TRUCK_E_GARAGE_2_SPAWN [PT_TRUCK_E_GARAGE_POS, PT_TRUCK_E_GARAGE_ROT]
#define PT_TRUCK_E_GARAGE_POS [12456.072, 12546.477, 0.452]
#define PT_TRUCK_E_GARAGE_ROT 188

//Eastern Garage Slot #3
#define PT_TRUCK_E_GARAGE_3_SPAWN [PT_TRUCK_E_GARAGE_POS, PT_TRUCK_E_GARAGE_ROT]
#define PT_TRUCK_E_GARAGE_POS [12461.923, 12545.33, 0.373]
#define PT_TRUCK_E_GARAGE_ROT 188
